...
if (isset($_POST['submit'])) {
    ...
    $sql = "update product set product_name='$productName', product_description='$productDesc', consumer_price='',retailer_price='',sku='$sku', image='$filename',  image1='$filename1', image2='$filename2',  image3='$filename3', is_new='$isNew', is_topselling='$isTop', category_id='$mcategory', scat_id='' where id='$id'";
