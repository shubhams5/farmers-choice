                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="addvendor.php" method="post" enctype="multipart/form-data">
                                ...
                                <label for="dname">Shop Address </label>
                                <div class="form-group">
                                    <div class="form-line">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary m-t-15 waves-effect">Add Partner</button>
                            </form>
                        </div>
                    </div>
                </div>
