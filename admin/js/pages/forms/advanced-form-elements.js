$(function () {
    ...
    $demoMaskedInput.find('.height').inputmask('9.9', { placeholder: '_._', alias: "datetime" });

    //Mobile Phone Number
    $demoMaskedInput.find('.mobile-phone-number').inputmask('9999999999', { placeholder: '_-_-_-_-_-_-_-_-_-_' });
    //Phone Number
