...
extract($_POST);
	...
	$sql = "update product set product_name='$productName', product_description='$productDesc', product_price='$price', sku='$sku', stock='$stock', image='$filename',  image1='$filename1', image2='$filename2',  image3='$filename3', is_new='$isNew', is_topselling='$isTop', category_id='$mcategory', scat_id='$subcat' where id='$id'";
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="#" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="price" id="price" value="<?php echo $rp['product_price'];?>" class="form-control" placeholder="Enter price">
                                    </div>
                                </div>
                                </div>
                                <div class="col-sm-6">
                                <label for="stock">Enter Opening Stock</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="stock" name="stock" value="<?php echo $rp['stock'];?>" class="form-control" placeholder="Enter Stock">
                                    </div>
                                </div>
                                </div>
                            </div>
