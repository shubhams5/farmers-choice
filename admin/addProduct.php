...
extract($_POST);
	...
	$sql = "INSERT into `product` (id, product_name, product_description, consumer_price, retailer_price, sku, image,  image1, image2,  image3, is_new,active ,is_topselling, vendor_code, created_at, category_id, scat_id) values ('$id', '$productName', '$productDesc', '','', '$sku', '$filename','$filename1', '$filename2', '$filename3', '$isNew',1, '$isTop', 'Owner',now(), '$mcategory', '$subcat')";
