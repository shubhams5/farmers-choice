                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="addService.php" method="post" enctype="multipart/form-data">
                                ...
                                <label for="product_desc">Service Descriptation</label>
                                <div class="form-group">
                                    <div class="form-line">
                                ...
                                <label for="sku_number">Unit</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <select name="sku_number" id="sku_number" class="form-control">
                                            <?php
                            ...
                            <label for="file">Enter Product Image</label>
                                ...
                                <button type="submit" name="submit" class="btn btn-primary m-t-15 waves-effect">Continue to Add Size Color</button>
                            </form>
                        </div>
                    </div>
                </div>
